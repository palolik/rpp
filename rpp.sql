...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 24, 2023 at 09:24 AM
...
CREATE TABLE IF NOT EXISTS `devices` (
  ...
  `username` varchar(24) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `designation` varchar(28) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `department` varchar(19) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `pcname` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `pc/laptop` varchar(31) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `processor` varchar(27) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `motherboard` varchar(19) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `ram` varchar(29) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `hdd` varchar(14) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `ssd` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `cdrom` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `keyboard` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `mouse` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `ups` varchar(7) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `monitor` varchar(17) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `printer` varchar(33) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `scanner` varchar(19) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `speaker` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `webcam` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `headphone` varchar(9) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `os` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `pcip` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `pdate` varchar(13) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `warrenty` varchar(14) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `maintenaceh` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `userh` varchar(96) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `comments` varchar(81) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `uprec` varchar(29) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  PRIMARY KEY (`si`)
...
INSERT INTO `devices` (`si`, `username`, `designation`, `department`, `pcname`, `pc/laptop`, `processor`, `motherboard`, `ram`, `hdd`, `ssd`, `cdrom`, `keyboard`, `mouse`, `ups`, `monitor`, `printer`, `scanner`, `speaker`, `webcam`, `headphone`, `os`, `pcip`, `pdate`, `warrenty`, `maintenaceh`, `userh`, `comments`, `uprec`) VALUES
(1, 'User Name', 'Designation', 'Department', 'PC Name', 'PC/Laptop Model', 'Processor', 'Motherboard', 'Ram', 'HDD', 'SSD', 'CD-ROM', 'Keyboard', 'Mouse', 'UPS', 'Monitor', 'Printer', 'Scanner', 'Speaker', 'Webcam', 'HeadPhone', 'OS', 'PC_IP', 'Purchase Date', 'Warranty Info', 'Maintenace History', 'User History', 'Comments ', 'Upgradation Recommendation'),
(2, 'Md. Abdus Sabur', 'Managing Director', 'MD Office', '', 'Dell Optiplex 4590 AIO', 'Intel Core i5 11500@1.50', '', '8 GB DDR4 3200', '1 TB WD', '256 GB Dahua', 'No', 'Yes', 'Yes', '650 VA', '', '', '', 'Built-in', 'Built-in', '', 'Win 10 64 Pro', '', '08.02.2022', '3 Years', '', '', '', ''),
(3, 'Md. Salim Bhuiyan', 'Executive Director', 'Engineering', 'EDEngg-PC', 'Dell Optiplex 4590 AIO', 'Intel Core i5 11500@1.50', '', '8 GB DDR4 3200', '1 TB WD', '256 GB Dahua', 'No', 'Yes', 'Yes', '650 VA', '', '', '', 'Built-in', 'Built-in', '', 'Win 10 64 Pro', '192.168.1.36', '08.02.2022', '3 Years', '', '', '', ''),
(4, 'Abul Khair Chowdhury', 'Executive Director', 'Finance', 'ED_Finance', 'HP Prodesk 400 G7', 'Intel Core i5 10500', '', '8 GB DDR4 3200', '1TB', '512 GB', 'Yes', 'Yes', 'Yes', '650 VA', '', 'Canon 6230 DN', 'No', '', '', '', 'Win 10 64', '192.168.1.122', '12.08.2021', '3 Years', '', '', '', ''),
(5, 'Praloy Kumar Saha', 'General Manager (A/F)', 'Finance', 'Praloy-PC', '', 'Intel Core i5 6400', 'Unkown', '8 GB DDR4 2133', '1 TB Toshiba', 'No', 'ASUS DRW', 'Yes', 'Yes', '650 VA', '', 'Canon LBP 6000', 'No', '', '', '', 'Win 7 64 Ultimate', '192.168.1.53', '', '', '', '', 'Marked as Extra at Finance DepartmentNo User till retirement of Praloy Kumar Saha', ''),
(6, 'Mahbubur Rahman', 'General Manager (HR & Admin)', 'HR-Admin', 'GMHR-PC', '', 'Intel Core 2 Quad 8200@2.33', 'Intel ECG3510M', '2 GB DDR2 800', '256 GB Samsung', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'Canon LBP6030', 'No', '', '', '', 'Win 7 32 Ultimate', '192.168.1.19', '', '', '', '', 'Marked as Extra at HR Department No User till retirement of Md. Mahbubur Rahman', ''),
(7, 'Md. Ashraf Hossain', 'Chief Engineer', 'Engineering', 'CEOnM-PC', '', 'Intel Core i5 4590', 'MSI 7817', '4 GB DDR3 1600', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'Canon LBP 6030\nEPSON L1300 Colour', 'No', '', '', '', 'Win 7 32', '', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(8, 'Sushanta Kumar Saha', 'Chief Engineer', 'Engineering', 'CEPnD-PC', 'Dell Optiplex 3080', 'Intel Core i5 10500@3.10', '', '8 GB DDR4 3200', '1 TB', '512 GB', 'Yes', 'Yes', 'Yes', '650 VA', 'Dell 22\"', 'Canon LBP 6230 DN', 'No', 'Built-in', 'Yes', 'No', 'Win 10 64 Pro', 'dhcp with NAT from Wifi Router', '21.12.2021', '1 Year', '', '', '', ''),
(9, 'Md. Shahjahan Faquir', 'Deputy General Manager', 'Finance', 'GMFA-PC', 'HP ProDesk 400 G7 Microtower PC', 'Intel Core i5 10500', '', '8 GB DDR4 3200', '1 TB WD', '512 GB', 'Yes', 'Yes', 'yes', '650 VA', '', 'No', 'No', 'Built-in', 'No', 'Built-in', 'Win 10 64 Pro', '192.168.1.51', '13.09.2022', '1 Year Full PC', '', '', '', ''),
(10, 'Kamal Hossain', 'Deputy General Manager', 'HR-Admin', 'MANAGERHR', '', 'Intel Core i5 4590@3.30', 'MSI 7817', '4 GB DDR3 1600', '500 GB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'HP LaserJet Pro P1102', 'No', '', '', '', 'Win 7 32 Ultimate', '192.168.1.55', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(11, 'Prantush Chandra Shaha', 'Company Secretary', 'Company Secretariat', 'CS-PC', '', 'Intel Core i3 4130', 'MSI 7817', '2 GB DDR3 1333', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 7 32', '192.168.1.58', '', '', '', '', '', '8 GB DDR3 1333/1600 (single)'),
(12, 'A.K.M. Mahmudul Alam', 'Manager', 'Audit', '	ManagerAudit-PC', 'Dell Optiplex 3080', 'Intel Core i5 10500@3.10', '', '8 GB DDR4 3200', '1 TB WD', '512 GB', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', 'Built-in', 'Yes', '', 'Win 10 64 Pro', 'dhcp with NAT from Wifi Router', '21.12.2021', '1 Year', '', '', '', ''),
(13, 'Md. Ferdaws Rahman', 'Executive Engineer', 'Engineering', '	\nWIN-BI6I2E42R06', '', 'Intel Core i5 4590@3.30', 'MSI 7817', '4 GB DDR3 1600', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'Canon LBP 3300', 'No', 'No', 'No', 'No', 'Win 10 64 Pro', '192.168.1.59', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(14, 'Mohammad Asaduzzaman', 'Executive Engineer', 'Engineering', 'Asad-EXEN', '', 'Intel Core i5 9400@2.90', 'AsRock H310M', '8 GB DDR4 2400', '1 TB Toshiba', '120 GB', 'Yes', 'Yes', 'Yes', '650 VA', 'Samsung 18.5\"', 'Canon LBP 3300', 'No', 'No', 'Yes', 'Yes', 'Win 10 64 Pro', '192.168.1.64', '', '', '', '', '', ''),
(15, 'Mirza Safiqul Islam', 'Executive Engineer', 'Engineering', 'MirzaShofiq-PC', '', 'Intel Core i5 6402', 'MSI 7996', '4 GB DDR4 2133', '1 TB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 7 64', '192.168.1.73', '', '', 'IP Issue 29.05.2022', '1. Jahangir Alam Majumder SE\n2. Mirza Shafiqul Islam XEN', '', '8 GB DDR4 2133 (Single)'),
(16, 'Md. Humayun Akter', 'Executive Engineer', 'Engineering', 'Humayon-PC', 'Dell Optiplex 3080', 'Intel Core i5 10500@3.10', '', '8 GB DDR4 3200', '1 TB WD', '512 GB', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', 'Built-in', 'Yes', '', 'Win 10 64 Pro', '192.168.1.24', '', '', '', '', '', ''),
(17, 'Khandoker Shariful Islam', 'Manager', 'HR-Admin', 'rpcl-Sharif', '', 'Intel Core i3 4150@3.5', '', '4 GB DDR3 1600', '500 GB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 7 32 Ultimate', '', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(18, 'Mahmud Hossain', 'Manager', 'HR-Admin', 'Mahmud-PC', '', 'Intel Core i3 4130@3.40', 'MSI 7817', '4 GB DDR3 1333', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'Canon LBP 214 DN', 'No', '', '', '', 'Win 7 32 Ultimate', '192.168.1.62', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(19, 'Mohammad Ashikur Rahman', 'Manager', 'HR-Admin', 'ASHIKUR-TRAININ', '', 'Intel Core  i5 7400@3.0', 'Gigabyte H110M-S2PH', '4 GB DDR4 2400', '1 TB', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64', '192.168.1.56', '', '', '', '', '', '8 GB DDR4 2400 (Single)'),
(20, 'Mohiuddin Sarkar', 'Manager', 'Finance', 'DESKTOP-ST5KGIP', '', 'Intel Core  i5 7400@3.0', 'Gigabyte H110M-S2PH', '8 GB DDR4 2400', '1 TB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Pro', '192.168.1.18', '', '', '', '', '', ''),
(21, 'Shahidul Islam', 'Sub Divisional Engineer', 'Engineering', 'Shahid-PC', '', 'Intel Core i5 2400@3.10', 'Intel BEH6110H', '6 GB DDR3 1333', '500 GB WD', '240 GB Transcend', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Pro', '', '', '', '', '', '', ''),
(22, 'Mohammad Rizvi Shahriar', 'Sub Divisional Engineer', 'Engineering', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(23, 'Md. Saleh Asfaqul Karim', 'Sub Divisional Engineer', 'Engineering', 'Saleh-PC', '', 'Intel Core i5 7400@3.00', 'Asus', '8 GB DDR4 2400', '1 TB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Pro', '192.168.1.76', '', '', '', '', '', ''),
(24, 'Rayhan Sharif', 'Sub Divisional Engineer', 'Engineering', 'Raihan-PC', '', 'Intel Dual Core 5400@2.70', 'Gigabyte G41 Combo', '3 GB DDR2 800', '320 GB Samsung', 'No', 'No', 'Yes', 'Yes', '650 VA', '', 'Canon LBP 3300', 'No', '', '', '', 'Win 7 32 Ultimate', '192.168.1.42', '', '', '', '', '', 'extra 4 GB DDR3 1333 (single)'),
(25, 'Md. Mostafizur Rahman', 'Deputy Manager', 'Finance', 'Accounts1-PC', '', 'Intel Core i3 2130@3.40', 'Intel DH61', '2 GB DDR3 1333', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', 'Samsung 18.5', 'No', 'No', 'No', 'No', 'No', 'Win 7 32 Ultimate', '192.168.1.14', '', '', '', '', '', 'extra 4 GB DDR3 1333 (single)'),
(26, 'Natasha Zaman', 'Deputy Manager', 'Company Secretariat', 'Natasha-PC', 'HP ProDesk 400 G7 Microtower PC', 'Intel Core i5 10500', '', '8 GB DDR4 3200', '1 TB WD', '512 GB', 'Yes', 'Yes', 'yes', '650 VA', '', 'No', 'No', 'Built-in', 'No', 'Built-in', 'Win 10 64 Pro', '192.168.1.12', '13.09.2022', '1 Year Full PC', '', '', '', ''),
(27, 'Nahil Ahmed', 'Deputy Manager', 'HR-Admin', 'Nahil-Admin', '', 'Intel Dual Core 5400@2.70', 'Gigabyte G31 M', '3 GB DDR2 800', '256 GB Hitachi', 'No', 'No', 'Yes', 'Yes', '650 VA', '', 'No', 'HP Scanjet Pro 2500', '', '', '', 'Win 7 32 Ultimate', '192.168.1.80', '', '', 'Fresh Installation on 21.11.2022', '', '', '120 GB SSD'),
(28, 'Zoynal Abedin Bhuiya', 'Deputy Manager', 'HR-Admin', 'Zoynal-PC', '', 'Intel Core i5 4460', 'MSI 7817', '4 GB DDR3 1600', '500 GB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'Yes', '', '', '', 'Win 7 32', '', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(29, 'Subroto Debnath', 'Sub Divisional Engineer', 'Engineering', 'Subroto-PC', '', 'Intel Core i5 6400@2.70', 'MSI 7A15', '4 GB DDR4 2133', '1 TB Toshiba', '240 GB Transcend', 'ASUS DRW', 'Yes', 'Yes', '650 VA', '', 'Canon LBP 3300', 'No', '', '', '', 'Win 10 64 Pro', '192.168.1.44', '', '', '', '', '', '8 GB DDR4 2133 (Single)'),
(30, 'Mohammad Kamal Hossain', 'Deputy Manager', 'HR-Admin', 'KAMAL-HR', '', 'Intel Core i3 4150@3.5', 'Gigabyte H110M-S2PH', '4 GB DDR3 1600', '500 GB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', 'No', 'No', 'No', 'Win 7 32 Ultimate', '192.168.1.23', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(31, 'Rumana Afroz', 'Deputy Manager', 'HR-Admin', 'Rumana-PC', '', 'Intel Core i5 7400@3.0', 'MSI 7A15', '12 GB DDR4 2400', '1 TB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Pro', '', '', '', 'New OS install on 17.07.2022', '', '', ''),
(32, 'Md. Shafiqul Islam', 'Deputy Manager', 'Audit', 'Shafiq-PC', 'Dell Optiplex 3080', 'Intel Core i5 10500@3.10', '', '8 GB DDR4 3200', '1 TB WD', '512 GB', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', 'Built-in', 'Yes', '', 'Win 10 64 Pro', '192.168.1.20', '21.12.2021', '1 Year', '', '', '', ''),
(33, 'Md. Abdul Baten', 'Deputy Manager', 'ICT', 'BATEN-ICT', '', 'Intel Core i3 4150@3.5', '	Gigabyte H81M-DS2V', '12 GB DDR3 1600', '500 GB', '240 GB', 'No', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64', '192.168.1.11', '', '', 'Add SSD on 30.05.2022', 'Md. Abdul Baten - August 2015', '', ''),
(34, 'Md. Rafejul Islam', 'Assistant Engineer', 'Engineering', 'Shamir-PC', '', 'Intel Core i3 4150@3.5', '	Gigabyte H81M-DS2V', '4 GB DDR3 1600', '500 GB Toshiba', 'No', 'CD Rom', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 7 32 Ultimate', '192.168.1.31', '', '', '', 'Abdus Shamir Talukdar\nMd. Refazul Islam- 21 July 2022', '', '8 GB DDR3 1600 (Single)'),
(35, 'Md. Moazzam Hossain', 'Assistant Engineer', 'Engineering', 'Moazzam-PC', '', 'Intel Core i5 6400@2.70', 'MSI 7996', '4 GB DDR4 2133', '320 GB Hitachi', 'No', 'ASUS DRW', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Pro', '192.168.1.75', '', '', '', '', '', '8 GB DDR4 2133 (Single)'),
(36, 'Kimiya Reza', 'Assistant Engineer', 'Engineering', 'Kimiya-PC', '', 'Intel Core i3 4150', '	Gigabyte H81M-DS2V', '4 GB DDR3 1600', '500 GB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 7 32 Ultimate', '192.168.1.43', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(37, 'Nowshin Zahan', 'Assistant Engineer', 'Engineering', 'Prasanta-PC', '', 'Intel Core i3 4130@3.40', 'MSI 7817', '4 GB DDR3 1333', '500 GB WD', '240 Transcend', 'Yes', 'Yes', 'Yes', '650 VA', '', '', '', '', '', '', 'Win 10 64 Pro', '192.168.1.64', '', '', '', '1. Prasanta Kumar Sutradhar-EXEN\n2. Nowshin Zahan -AE', '', '8 GB DDR3 1600 (Single)'),
(38, 'Wahiudozzaman', 'Assistant Engineer', 'Engineering', 'DESKTOP-M46S788', '', 'Intel Core i5 4590@3.30', 'MSI 7817', '4 GB DDR3 1600', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Enterprise', '192.168.1.3', '', '', '', '1. Faisol Ahmed AE\n2. Wahiudozzaman AE', '', '8 GB DDR3 1600 (Single)'),
(39, 'Md. Sarowar Zahan', 'Assistant Manager', 'ICT', 'Sarowar-pc', '', 'Intel Core i5 6400@2.70', 'Asus', '8 GB DDR4 2133', '1 TB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Pro', '192.168.1.82', '', '', '', '', '', ''),
(40, 'Md. Nazrul Islam', 'Assistant Manager', 'Finance', 'Nazrul-PC', '', 'Intel Core i5 6400@2.70', 'MSI 7996', '8 GB DDR4 2133', '1 TB Toshiba', 'No', 'ASUS DRW', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Pro', '192.168.1.123', '', '', '', '', '', ''),
(41, 'Md. Mamunur Rashid', 'Assistant Manager', 'Finance', 'Mamun-PC', 'HP ProDesk 600 G6', 'Intel Core i5 10500@3.10', '', '8 GB DDR4 3200', 'No', '512 GB', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', 'Built-in', 'No', 'No', 'Win 10 64 Pro', '192.168.1.38', '15.09.2021', '3 Years', '', '', '', ''),
(42, 'Fairooz Nawar Sarafi', 'Assistant Engineer', 'Engineering', 'Sharafi-PC', '', 'Intel Core i5 7400', 'MSI 7A15', '4 GB DDR4 2133', '500 GB WD', 'No', 'ASUS DRW', 'Yes', 'Yes', '650 VA', '', 'Canon LBP 3300', 'No', '', '', '', 'Win 7 64', '192.168.1.83', '', '', '', '', '', '8 GB DDR4 2133 (Single)'),
(43, 'Sharmin Sultana', 'Assistant Engineer', 'Engineering', 'Mehedi-PC', '', 'Intel Core 2 Duo@3.0', '', '2 GB DDR2 800', '256GB  ', '', 'No', 'Yes', 'Yes', '650 VA', 'HP 18.5 (SQ)', 'No', 'No', 'No', 'No', 'No', 'Win 7 32 Ultimate', '192.168.1.60', '', '', '', '', '', ''),
(44, 'S.M. Mehedi Hasan', 'Assistant Engineer', 'Engineering', 'DESKTOP-06NLRIB', '', 'Intel Core i5 4590@3.30', 'MSI 7817', '4 GB DDR3 1600', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', 'Samsung 18.5', 'No', 'No', 'No', 'No', 'No', 'Win 10 64 Enterprise', '192.168.1.29', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(45, 'Salma Ahmed', 'Assistant Manager', 'HR-Admin', 'Salma-PC', '', 'Intel Dual Core E5400@2.70', 'Gigabyte G41 Combo', '3 GB DDR2 800', '500 GB', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'Canon Lide 220', 'No', 'No', 'No', 'Win 7 32 Ultimate', '192.168.1.34', '', '', '', '', '', 'extra 4 GB DDR3 1333 (single)'),
(46, 'Muhammad Sawkat Ali', 'Assistant Manager', 'Finance', 'ARUP-PC', '', 'Intel Dual Core E5700@3.0', 'Gigabyte G41 Combo', '2 GB DDR3 1333', '500 GB Samsung', 'No', 'Yes', 'Yes', 'Yes', '650 VA', 'Samsung 18.5 (SQ)', 'No', 'No', 'No', 'No', 'No', 'Win 7 32 Ultimate', '192.168.1.229', '', '', '', '1. Arup Ratan Barua- Asst. Accountant\n2. Shawkat Ali- AM', '', 'extra 4 GB DDR3 1333 (single)'),
(47, 'A.K.M. Fazlul Huq', 'Assistant Manager', 'Finance', 'fazlu-pc', 'HP ProDesk 400 G7 Microtower PC', 'Intel Core i5 10500', '', '8 GB DDR4 3200', '1 TB WD', '512 GB', 'Yes', 'Yes', 'yes', '650 VA', '', 'No', 'No', 'Built-in', 'No', 'Built-in', 'Win 10 64 Pro', '192.168.1.12', '13.09.2022', '1 Year Full PC', '', '', '', ''),
(48, 'Sumaya Afrin', 'Sub Assistant Engineer', 'Engineering', 'SUMAYA1-PC', '', 'Intel Core  i5 6400', '	MSI 7996', '4 GB DDR4 2133', '500 GB', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', '', 'No', '', '', '', 'Win 10 64', '192.168.1.22', '', '', '', '', '', '8 GB DDR4 2133 (Single)'),
(49, 'Bazlur Rahman', 'Junior Assistant Manager', 'Finance', 'Bazlu-PC', '', 'Intel Core i3 4130', 'Gigabyte H81M-S2PV', '2 GB DDR3 1333', '1 TB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'Canon LBP 6230 DN', 'No', '', '', '', 'Win 7 32', '192.168.1.50', '', '', '', '', '', '8 GB DDR3 1333/1600 (Single)'),
(50, 'Md. Saddam Hossain', 'Junior Assistant Manager', 'HR-Admin', 'Saddam-PC', '', 'Intel Core i5 7400@3.00', 'Gigabyte H110M-S2PH', '8 GB DDR4 2400', '1 TB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Pro', '192.168.1.30', '', '', '', '', '', ''),
(51, 'Md. Shakil Jaman', 'Junior Assistant Manager', 'Audit', 'Shakil', '', 'Intel Core i5 4590@3.30', 'MSI 7817', '4 GB DDR3 1600', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 7 32 Ultimate', '192.168.1.48', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(52, 'Sharmin Sultana', 'Receptionist', 'HR-Admin', 'Sharmin_Sultana-PC', '', 'Intel Dual Core E5700@3.0', 'Gigabyte G41 Combo', '2 GB DDR3 1333', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', 'Samsung 18.5', 'No', 'No', 'No', 'No', 'No', 'Win 7 32 Ultimate', '192.168.1.66', '', '', '', '1. Rumana DM (HR/Admin)\n2. Sharmin Sultana-Receptioninst', '', 'extra 4 GB DDR3 1333 (single)'),
(53, 'Wahid Tareq', 'Office Assistant', 'Engineering', 'Tareq-PC', '', 'Intel Core i5 6400@2.70', 'Asus H110M-K', '4 GB DDR4 2133', '1 TB Toshiba', '240 GB', 'Yes', 'Yes', 'Yes', '650 VA', 'Samsung 18.5', 'No', 'No', 'No', 'No', 'No', 'Win 10 64 Pro', '192.168.1.74', '', '', '', '', '', '8 GB DDR4 2133 (Single)'),
(54, 'Borhan', 'Auditor', 'Audit', 'Borhan-PC', '', 'Intel Core i3 4130', 'MSI 7817', '2 GB DDR3 1333\n4 GB DDR3 1600', '500 GB', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64', '192.168.1.69', '', '', 'Add 4 GB Ram on 28.05.2022', '1. Manager Audit\n2. Borahan Auditor', '', ''),
(55, 'Meherun Nisa EVA', 'Office Assistant', 'Engineering', 'EVA-PC', '', 'Intel Core i5 7400', 'Gigabyte H110M-DS2', '8 GB DDR4 2400', '1 TB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64', '192.168.1.40', '', '', '', '', '', ''),
(56, 'Share Server', '', '', 'Lighthouse', '', 'Intel Core i5 6400', 'Asus', '4 GB DDR4 2133', '1 TB', 'No', 'Yes', 'Yes', 'Yes', '1200 VA', '', 'No', 'No', '', '', '', 'Win Server 2012', '192.168.1.4', '', '', '', '', '', '8 GB DDR4 2133 (Single)'),
(57, 'Tania Parvin', 'Office Secretary', 'Engineering', 'Tania-PC', '', 'Intel Core i5 6400@2.70', 'MSI 7A15', '8 GB DDR4 2133', '1 TB WD', 'No', 'ASUS DRW', 'Yes', 'Yes', '650 VA', '', 'Canon LBP 6230 DN', 'No', '', '', '', 'Win 10 64 Enterprize', '192.168.1.156', '', '', '', '', '', ''),
(58, 'Hafsa Fariha', 'Junior Assistant Mangager', 'HR-Admin', 'Ehsan-PC', '', 'Intel Core i3@2120', 'Unknown', '2 GB DDR3 1333', '1 TB WD', 'No', 'CD Rom', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 7 32 Ultimate', '192.168.1.63', '', '', '', '', '', ''),
(59, 'Mukta', 'Junior Assistant Mangager', 'HR-Admin', 'Mukta-PC', '', 'Intel Core i5 6400@2.70', 'MSI 7996', '4 GB DDR4 2133', '500 GB WD', 'No', 'ASUS DRW', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Pro', '192.168.1.121', '', '', 'New OS Install on 16.06.2022', '', 'Patuakhali Project PC', '8 GB DDR4 2133 (Single)'),
(60, 'Moushumi', 'Asst Accountant', 'Finance', 'Moushumi-PC', '', 'Intel Core i5 7400@3.0', 'Gigabyte H110M-S2PH', '8 GB DDR4 2400', '1 TB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Pro', '192.168.1.26', '', '', '', '', '', ''),
(61, 'Md. Mostakim Hossen', 'Sub Assistant Engineer', 'Engineering', 'Mostakim-PC', '', 'Intel Core i7 2600@3.40', 'Intel BLH6710H', '2 GB DDR3 1333', '1 TB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 7 64 Ultimate', '192.168.1.197', '', '', '', '', '', '8 GB DDR3 1033/1333 (Single)'),
(62, 'Marufa Khatun', 'Receptionist', 'Engineering', 'Marufa-PC', '', 'Intel Core i3 4150@3.50', 'Gigabyte H81M-S2PV', '4 GB DDR3 1600', '1 TB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'Canon LBP 6300 DN', 'HP Scanjet Pro 2500', '', '', '', 'Win 10 64 Pro', '192.168.1.54', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(63, 'Shamim Mia', 'Asst Accountant', 'Finance', 'Mamun-PC', '', 'Intel Core2Duo 7500@2.93', 'Intel G4110H', '4 GB DDR2 800', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 7 32 Ultimate', '192.168.1.118', '', '', '', '', '', ''),
(64, 'Mahbub Alam Khan', 'Store Keeper', 'Finance', 'Mahbub-PC', '', 'Intel Core i5 7400@3.0', 'Gigabyte H110M-S2PH', '8 GB DDR4 2400', '1 TB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 10 64 Enterprise', '192.168.1.49', '', '', '', '', '', ''),
(65, 'Amran', 'Asst Accountant', 'Finance', 'AMRAN-PC', '', 'Intel Core i3 4150@3.50', 'Gigabyte H81M-S2PV', '4 GB DDR3 1600', '500 GB Toshiba', 'No', 'No', 'Yes', 'Yes', '650 VA', '', 'No', 'No', '', '', '', 'Win 7 32 Ultimate', '192.168.1.81', '', '', '', '', '', '8 GB DDR3 1600 (Single)'),
(66, 'Saddam ', 'Asst Accountant', 'Finance', 'saddam_acct-pc', '', 'Intel Core i3 4130@3.40', 'MSI 7817', '8 GB DDR3 1600', '500 GB Toshiba', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', 'No', 'No', 'No', 'Win 10 64 Pro', 'Dhcp', '', '', 'Fresh Installation on 24.10.2022', '1. Fazlul Huq -AM\n2. Saddam', '', ''),
(67, 'Golam Mostafa', 'Asst. Manager (Finance)', 'Engineering', '', 'Dell Optiplex 3080', 'Intel Core i5 10500@3.10', '', '8 GB DDR4 3200', '1 TB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', 'Built-in', 'Yes', '', 'Win 10 64 Pro', '', '21.12.2021', '1 Year', '', '', '', ''),
(68, 'Finance Common', '', 'Finance', 'finance_common-pc', '', 'Intel Core2Duo 7500@2.93', 'Intel G4110H', '4 GB DDR2 800', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'HP Scanjet Pro 2600', 'No', 'No', 'No', 'Win 10 64 Pro', 'Dhcp', '', '', 'Fresh Installation on 30.10.2022', '1. Mohammad Erfan- Manager\n2. Shahjahan Faqire- DGM (Finance)\n3. Finance Common', '', ''),
(69, 'Abdur Razzak', 'Sub Assistant Engineer', 'Engineering', 'Razzak-PC', '', 'Intel Core i3 2130@3.40', 'Unknown', '2 GB DDR3 1333', '500 GB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', 'No', 'No', 'No', 'Win 7 32 Ultimate', 'Dhcp', '', '', 'Fresh Installation on 15.11.2022', '1. Kazi Mohammad Tanvir- Manager (CS)\n2. Natasha Zaman- DM (CS)\n3. Md. Abdur Razzak -SAE (Civil)', '', 'Upgrade with another 2 GB'),
(70, 'Nazmul Hossain', 'Office Assistant', 'Company Secretariat', 'CS-JAM', '', 'Intel Core i5 8400@2.80', 'Gigabyte H310M', '8 GB DDR4 2400', '1 TB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', 'Samsung 18.5\"', 'No', 'HP Scanjet Pro 2500', 'No', 'No', 'No', 'Win 10 64 Pro', '192.168.1.117', '', '', '', '', '', ''),
(71, 'Md. Arshad Hossain\n \n', 'Assistant Manager (A&F)', 'Madargganj Project', '', 'Dell Optiplex 3080', 'Intel Core i5 10500@3.10', '', '8 GB DDR4 3200', '1 TB WD', 'No', 'Yes', 'Yes', 'Yes', '650 VA', '', 'No', 'No', 'Built-in', 'Yes', '', 'Win 10 64 Pro', '', '21.12.2021', '1 Year', '', '', 'Madarganj Project PC', '');
...
CREATE TABLE IF NOT EXISTS `employees` (
  `id` int NOT NULL AUTO_INCREMENT,
  `employeeid` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `employeecode` varchar(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `employeename` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `contactno` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `employees` (`id`, `employeeid`, `employeecode`, `employeename`, `officename`, `designation`, `contactno`, `email`, `status`) VALUES
(2, '180011001s', '0001s', 'Md. Abdus Saburs', 'Corporate Offices', 'Managing Directors', '01741330172s', 'md@rpcl.gov.bda', 'Workinga'),
(13, '180011265', '0288', 'Md. Amirul Islam', 'Corporate Office', 'Superintending Engineer (O &M)', '01726321445', 'smirty.amin@gmail.com', 'Working'),
(14, '180011010', '0267', 'Kamal Hossain', 'Corporate Office', 'Deputy General Manager (HR & Admin)', '01711-944767', 'kamaltradecom@gmail.com', 'Working'),
(15, '180011263', '0298', 'Md. Iqbal  Karim', 'Corporate Office', 'Superintending Engineer (O &M)', '01788111333', 'qblkarim@yahoo.com', 'Working'),
